...
extern int16_t pulse2Timer, pulse1Timer;
extern uint16_t triTimer, noiseShift, noiseTimer, dmcRate, dmcAddress, dmcCurAdd, dmcLength, dmcBytesLeft, dmcTemp;
extern const uint16_t noiseTable[0x10], dmcRateTable[0x02][0x10];
extern const uint8_t lengthTable[0x20];
